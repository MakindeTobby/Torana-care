                ...
                <div className="lg:flex lg:items-start lg:gap-8">
                    ...
                    <div className="grid lg:gap-8  mt-8 lg:mt-0 lg:grid-cols-12 lg:gap-y-16 md:grid-cols-8 sm:grid-cols-4">
                        ...
                        <div className='col-span-4 py-4'>
                            <a href="#" className="flex px-4 py-4 flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
