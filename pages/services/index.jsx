...
const Services = () => {
    return (
        <>
                    ...
                    <div className="grid gap-8  lg:mt-0 lg:grid-cols-12 lg:gap-y-16 md:grid-cols-6 sm:grid-cols-6">
                        ...
                        <div className='col-span-6 flex flex-col gap-10 pt-20'>
                            ...
                            <h1 className='lg:text-5xl md:text-3xl sm:text-3xl'>
                                ...
                                Making Specialised Disability Support  <span className='font-bold'>And Service Delivery,Easier To Access....</span>
                            </h1>
                    ...
                    <div className="grid gap-8 mt-8 lg:mt-0 lg:grid-cols-12 lg:gap-y-16 md:grid-cols-8 sm:grid-cols-4">
                        ...
                        <div className='col-span-4   '>
                            ...
                            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="p-5">
                                    <a href="#">
                                        <h5 class="mb-2 text-xl font-bold tracking-tight text-red-700 text-center dark:text-white">COMMUNITY NURSING</h5>
                                    </a>
                        ...
                        <div className='col-span-4   '>
                            ...
                            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="p-5">
                                    <a href="#">
                                        <h5 class="mb-2 text-xl font-bold tracking-tight text-red-700 text-center dark:text-white uppercase">Specialist Behaviour Support</h5>
                                    </a>
                                    <p class="mb-3 text-sm text-gray-700 dark:text-gray-400">
                        ...
                        <div className='col-span-4   '>
                            ...
                            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="p-5">
                                    <a href="#">
                                        <h5 class="mb-2 text-xl font-bold tracking-tight text-red-700 text-center dark:text-white uppercase">Social Support and Services</h5>
                                    </a>
                                    <p class="mb-3 text-sm text-gray-700 dark:text-gray-400">
                        ...
                        <div className='col-span-4   '>
                            ...
                            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="p-5">
                                    <a href="#">
                                        <h5 class="mb-2 text-xl font-bold tracking-tight text-red-700 text-center dark:text-white uppercase">Therapeutic Support</h5>
                                    </a>
                                    <p class="mb-3 text-sm text-gray-700 dark:text-gray-400">
                        ...
                        <div className='col-span-4   '>
                            ...
                            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="p-5">
                                    <a href="#">
                                        <h5 class="mb-2 text-xl font-bold tracking-tight text-red-700 text-center dark:text-white uppercase">Household Task Support</h5>
                                    </a>
                                    <p class="mb-3 text-sm text-gray-700 dark:text-gray-400">
                        ...
                        <div className='col-span-4   '>
                            ...
                            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="p-5">
                                    <a href="#">
                                        <h5 class="mb-2 text-xl font-bold tracking-tight text-red-700 text-center dark:text-white uppercase">Exercise Physiology and Personal Training</h5>
                                    </a>
                                    <p class="mb-3 text-sm text-gray-700 dark:text-gray-400">
                        ...
                        <div className='col-span-4   '>
                            ...
                            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="p-5">
                                    <a href="#">
                                        <h5 class="mb-2 text-xl font-bold tracking-tight text-red-700 text-center dark:text-white uppercase">Group and Centre-Based Activities</h5>
                                    </a>
                                    <p class="mb-3 text-sm text-gray-700 dark:text-gray-400">
                        ...
                        <div className='col-span-4   '>
                            ...
                            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="p-5">
                                    <a href="#">
                                        <h5 class="mb-2 text-xl font-bold tracking-tight text-red-700 text-center dark:text-white uppercase">Specialist Support Coordination</h5>
                                    </a>
                                    <p class="mb-3 text-sm text-gray-700 dark:text-gray-400">
                        ...
                        <div className='col-span-4   '>
                            ...
                            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="p-5">
                                    <a href="#">
                                        <h5 class="mb-2 text-xl font-bold tracking-tight text-red-700 text-center dark:text-white uppercase">Complex Health Care Support</h5>
                                    </a>
                                    <p class="mb-3 text-sm text-gray-700 dark:text-gray-400">
                        ...
                        <div className='col-span-4   '>
                            ...
                            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="p-5">
                                    <a href="#">
                                        <h5 class="mb-2 text-xl font-bold tracking-tight text-red-700 text-center dark:text-white uppercase">Accommodation/Tenancy Assistance</h5>
                                    </a>
                                    <p class="mb-3 text-sm text-gray-700 dark:text-gray-400">
                        ...
                        <div className='col-span-4   '>
                            ...
                            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="p-5">
                                    <a href="#">
                                        <h5 class="mb-2 text-xl font-bold tracking-tight text-red-700 text-center dark:text-white uppercase">Assistive Support and Services</h5>
                                    </a>
                                    <p class="mb-3 text-sm text-gray-700 dark:text-gray-400">
                        ...
                        <div className='col-span-4   '>
                            ...
                            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="p-5">
                                    <a href="#">
                                        <h5 class="mb-2 text-xl font-bold tracking-tight text-red-700 text-center dark:text-white uppercase">Capacity Building Support and Services</h5>
                                    </a>
                                    <p class="mb-3 text-sm text-gray-700 dark:text-gray-400">
                        ...
                        <div className='col-span-4   '>
                            ...
                            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="p-5">
                                    <a href="#">
                                        <h5 class="mb-2 text-xl font-bold tracking-tight text-red-700 text-center dark:text-white uppercase">Group/Shared Supported Living,Supported Independent Living/Respite</h5>
                                    </a>
                                    <p class="mb-3 text-sm text-gray-700 dark:text-gray-400">
                        ...
                        <div className='col-span-4   '>
                            ...
                            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="p-5">
                                    <a href="#">
                                        <h5 class="mb-2 text-xl font-bold tracking-tight text-red-700 text-center dark:text-white uppercase">Support Coordination</h5>
                                    </a>
                                    <p class="mb-3 text-sm text-gray-700 dark:text-gray-400">
                        ...
                        <div className='col-span-4 '>
                            ...
                            <div class="max-w-sm hover:shadow-lg  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="p-5">
                                    <a href="#">
                                        <h5 class="mb-2 text-xl font-bold tracking-tight text-red-700 text-center dark:text-white uppercase">CALD Community Participation</h5>
                                    </a>
                                    <p class="mb-3 text-sm text-gray-700 dark:text-gray-400">
            ...
            <div className=' w-full bg-blue-700 lg:px-28 md:px-4 mt-8 py-6'>

                <div className='w-full flex items-center flex-wrap sm:flex-col md:px-2 sm:px-2 justify-between'>
